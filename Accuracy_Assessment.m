...
%% RMSE Calculation 
start=(5/20) * length(Id_KF_Single);
finish=(7.5/20) * length(Id_KF_Single); 
...
grid on ; 
xlabel('t[$s$]','FontSize',14, 'Interpreter','latex');
ylabel('$T_j[^{\circ}C]$','FontSize',14, 'Interpreter','latex');
...
xlabel('t[$s$]','FontSize',14, 'Interpreter','latex');
ylabel('$V_{ds}[V]$','FontSize',14, 'Interpreter','latex');
title('Drain-Source Voltage Emulation','FontSize',18);
...
xlabel('t[$s$]','FontSize',14, 'Interpreter','latex');
ylabel('$I_d[A]$','FontSize',14, 'Interpreter','latex');
title('Drain Current Emulation','FontSize',18);
if num==1
...
xlabel('t[$s$]','FontSize',14, 'Interpreter','latex');
ylabel('$R_{dson}[m\Omega]$','FontSize',14, 'Interpreter','latex');
title('On State Resistance Emulation','FontSize',18);
if num==1
 saveas(figure(11),'Constant_Noise/Experiment.eps','epsc');
end
if num==2 
 saveas(figure(11),'Dynamic_Noise/Current_Exper_dynamic.eps','epsc');
end
...
grid on ; 
xlabel('t[$s$]','FontSize',14, 'Interpreter','latex');
ylabel('$T_{j}[^{\circ}C]$','FontSize',14, 'Interpreter','latex');
title('Junction Temperature Emulation','FontSize',18);
if num==1
 saveas(figure(12),'Constant_Noise/Experiment_Junction_Temperature.eps','epsc');
end
if num==2 
 saveas(figure(12),'Dynamic_Noise/Current_Exper_dynamic.eps','epsc');
end
